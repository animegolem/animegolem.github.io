...
const targets = [
    ...
    { type:"Prefernce Curves",  files:["Golem Preference"] },
...
const  preference_bounds_name = "Bounds",  // Preference bounds name
       ...
       compTargets = ["Golem HRTF","ARI, HUTUBS, RIEC, SONICOM AVG","ISO 11904", "Golem Preference"],                     // Targets that are allowed to be used for compensation
...
function watermark(svg) {
    ...
    svg.append("g")
        .attr("opacity",0.2)
        .append("text")
        .attrs({x:765, y:314, "font-size":10, "color":hsl(194, 14%, 40%), "text-anchor":"end", "class":"site_name"})
