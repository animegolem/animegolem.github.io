...
const  preference_bounds_name = "Bounds",  // Preference bounds name
       ...
       tiltableTargets = ["Golem HRTF", "Left Only", "Right Only", "ARI, HUTUBS, RIEC, SONICOM AVG","ISO 11904"],                 // Targets that are allowed to be tilted
       compTargets = ["Golem HRTF", "Left Only", "Right Only", "ARI, HUTUBS, RIEC, SONICOM AVG","ISO 11904"],                     // Targets that are allowed to be used for compensation
